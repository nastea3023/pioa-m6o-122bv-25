...
|                        |          |                 | RW            | reserved_out | [3:2] | Номер запасного выхода команды.<br>3 - резервирование не производится.<br>(см. [Программирование. Арбитр](#arbiter-1)) | 2'h3                  |
...
2. При обращении в адресное пространство одного из подмодулей по неизвестному смещению сигнал ошибки **PSLVERR** выставляется в высокий уровень.
